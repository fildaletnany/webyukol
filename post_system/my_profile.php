        ...
        <header class="p-3 mb-3 border-bottom bg-light">
            <div class="container">
                <div class="d-flex justify-content-between">
                    <a class="d-flex align-items-center mb-2 mb-lg-0 bg-primary text-light text-decoration-none rounded p-2" href="https://zrostfi21.sps-prosek.cz/mysql/ukol/main_page.php">Main page</a>
                    <form class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3" role="search" action="search_my_profile.php" method="post">
                        <input type="search"class="form-control" type="search" name="search" placeholder="Search my profile...">
                    </form>
                    <div class="d-flex justify-content-between">
                        <a class="d-flex align-items-center mb-2 mb-lg-0 bg-primary text-light text-decoration-none rounded p-2 mx-2" href="new_post.php">New post</a>
                        <a class="d-flex align-items-center mb-2 mb-lg-0 bg-light text-decoration-none border rounded p-2 mx-2" href="my_profile.php">My profile (user ID:<?php echo $_SESSION['ID_user']; ?>)
                        </a>
                        <a class="d-flex align-items-center mb-2 mb-lg-0 bg-light text-decoration-none border rounded p-2 mx-2" href="https://zrostfi21.sps-prosek.cz/mysql/ukol/session_destroy.php">Log Out
                        </a>           
                    </div>
                </div>
            </div>
